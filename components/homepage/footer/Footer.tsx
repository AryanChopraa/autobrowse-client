      ...
      <div className="w-full max-w-screen-xl mx-auto py-4 px-4 md:py-8 text-bold">
        <div className="flex sm:items-center sm:justify-between  items-center justify-center flex-col sm:flex-row">
          <a href="/" className="flex items-center mb-4 sm:mb-0">
            <span className="self-center text-2xl  whitespace-nowrap text-white">autosurf.<text className="text-blue-500">ai</text></span>
          </a>
          <ul className="flex flex-wrap items-center mb-6 text-sm f text-white sm:mb-0">
            <li>
